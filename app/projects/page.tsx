...
export default function ProjectsMenuPage() {
  // DATA: Added 'image' property to each project
  const projects = [
    {
      title: "Project Evolution",
      category: "High-Performance Computing",
      description:
        "A massively parallel artificial life simulation. Optimized from single-threaded C# to a C++ & CUDA architecture.",
    ...
    },
    {
      ...
      description:
        "Injecting modern multiplayer networking into a 2003 single-player engine via memory analysis and DLL injection.",
    ...
    },
    {
      ...
      description:
        "Competition-winning project transforming a prototype into a scalable multiplayer platform with complex asset management.",
      highlight: "Award Winner",
      tech: ["Unity 3D", "C#", ".NET"],
      href: "/projects/game-dev",
      image: "/chronoment.jpg",
      icon: (
        <svg
          className="w-10 h-10 text-[#d67d7d]"
          fill="none"
    ...
    <main className="bg-[#2d2a26] min-h-screen font-sans text-[#39352f]">
      ...
      <div className="max-w-6xl mx-auto bg-[#e5e5e5] shadow-2xl min-h-screen flex flex-col">
        ...
        <section className="p-10 md:p-16 border-b border-[#b8b8b8] bg-[#39352f] text-[#d1d1d1]">
          <div className="max-w-4xl">
            ...
            <p className="text-xl leading-relaxed opacity-90 border-l-4 border-[#d67d7d] pl-6">
              A collection of technical deep dives. From reverse engineering
              legacy engines to optimizing high-performance genetic algorithms.
            </p>
          </div>
        </section>
        ...
        <div className="p-10 md:p-16 flex-1 bg-[#e5e5e5]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                <article className="h-full flex flex-col bg-[#39352f] text-[#d1d1d1] shadow-lg border-2 border-transparent transition-all duration-300 hover:border-[#d67d7d] hover:-translate-y-2 overflow-hidden">
                  {/* NEW: Project Image Section */}
                  {/* overflow-hidden ensures the zoom effect stays inside the box */}
                  <div className="h-48 w-full overflow-hidden border-b border-[#555] relative">
                    {/* Placeholder color overlay to blend images with theme */}
                    <div className="absolute inset-0 bg-[#d67d7d] mix-blend-multiply opacity-0 group-hover:opacity-20 transition-opacity duration-300 z-10" />
                  ...
                  {/* Card Header */}
                  <div className="p-6 border-b border-[#555] flex justify-between items-start relative z-20 bg-[#39352f]">
                  ...
                  {/* Card Body */}
                  <div className="p-6 flex-1 flex flex-col bg-[#39352f]">
                    ...
                    <div className="flex flex-wrap gap-2 mt-auto">
                      {project.tech.map((t, i) => (
                        <span
                          key={i}
                          className="text-xs font-mono bg-[#2d2a26] px-2 py-1 rounded text-gray-300 border border-[#444]"
                        >
                          {t}
                        </span>
                      ))}
        ...
        <section className="bg-[#d1d1d1] p-10 md:p-16 border-t border-[#b8b8b8] text-center">
          <h2 className="text-2xl font-bold mb-4 text-[#39352f]">
            Want to see the code?
          </h2>
          <p className="text-[#39352f] opacity-80 mb-8 max-w-2xl mx-auto">
            Most of these projects are open-source and available for review. I
            am currently available for new engineering challenges.
          </p>
          <Link
            href="/contact"
            className="inline-block bg-[#39352f] text-white font-bold py-3 px-8 rounded hover:bg-[#d67d7d] transition-colors"
          >
            Contact Me
          </Link>
        </section>
