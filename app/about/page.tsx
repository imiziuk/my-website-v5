    ...
    <main className="bg-[#2d2a26] min-h-screen font-sans text-[#39352f]">
      ...
      <div className="max-w-5xl mx-auto bg-[#e5e5e5] shadow-2xl min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1 text-center md:text-left">
              <h1 className="text-3xl md:text-4xl font-black uppercase mb-4 tracking-tight">
                Developer. <span className="text-[#d67d7d]">Creator.</span> Mentor.
              </h1>
              <p className="text-lg leading-relaxed opacity-80 mb-6">
                I am an aspiring Computer Scientist fascinated by <b>Network Communication</b>, <b>Game Development</b>, and <b>Agentic AI</b>. My journey started with a simple goal: to build a game for my brother. Today, I'm building scalable software and simulating complex life systems.
              </p>
              <ContactButton />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="space-y-4">
              ...
              <p className="leading-relaxed">
                The first time I touched code, it was to create a video game to play with my little brother. Using <b>GameStudio</b>, I built a prototype where we could explore a map, collect coins, and solve puzzles together. 
              </p>
              <p className="leading-relaxed">
                That joy of creation pushed me toward more sophisticated tools. I dove into <b>Unity3D</b> and <b>C#</b>, learning not just how to make things move, but how to write clean, maintainable code conventions.
              </p>
            </div>
            <div className="bg-[#39352f] p-2 rounded-lg shadow-lg rotate-1 hover:rotate-0 transition-all">
               ...
               <img src="gmk.png" alt="Game Prototype" className="w-full h-auto object-cover rounded" />
            </div>
          </div>
        </section>
        ...
        <section className="p-10 md:p-16 bg-[#e5e5e5]">
          <div className="flex flex-col-reverse md:flex-row gap-10">
            ...
            <div className="flex-1 space-y-4">
              ...
              <p className="leading-relaxed">
                My passion for CS solidified when I discovered <b>Cellular Automata</b>—simulating the evolution of living organisms through code.
              </p>
              <p className="leading-relaxed">
                I implemented my own simulation, but I didn't stop there. I am currently optimizing this project using <b>OpenGL</b> and <b>CUDA</b> to handle massive parallel processing loads, pushing the boundaries of what my hardware can simulate.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#e5e5e5] p-8 rounded-lg border-l-4 border-[#d67d7d] hover:shadow-md transition-shadow">
              ...
              <p className="text-sm leading-relaxed opacity-90">
                I tutor Math and CS subjects. The challenge of explaining complex algorithms to different learning styles has sharpened my <b>communication skills</b>. This translates directly to how I document code and collaborate with engineering teams.
              </p>
            </div>
            ...
            <div className="bg-[#e5e5e5] p-8 rounded-lg border-l-4 border-[#39352f] hover:shadow-md transition-shadow">
              ...
              <p className="text-sm leading-relaxed opacity-90">
                I play flute, guitar, piano, and violin. Whether it's Ukrainian folk songs or Dark Academia fantasies, music teaches me discipline and pattern recognition—skills that are surprisingly transferable to software architecture.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="p-10 md:p-16 text-center bg-[#39352f] text-[#d1d1d1]">
          <h2 className="text-2xl font-bold mb-4 text-white">Striving for the Future</h2>
          <p className="max-w-2xl mx-auto text-lg leading-relaxed">
            I am actively seeking opportunities in <b>Network Management</b> and <b>Game Development</b>. My goal is to master the full stack to produce efficient, scalable products and eventually mentor the next generation of programmers.
          </p>
        </section>
