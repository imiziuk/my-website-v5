      ...
      <div className="max-w-6xl mx-auto bg-[#e5e5e5] shadow-2xl min-h-screen flex flex-col">
        ...
        <section className="p-10 md:p-16 border-b border-[#b8b8b8] bg-[#39352f] text-[#d1d1d1]">
          <div className="max-w-4xl">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8 border-l-4 border-[#d67d7d] pl-6">
              ...
              [cite_start]Achieved by reverse-engineering memory pointers and
              hooking into the main game loop. [cite: 122, 137]
            </p>
            ...
            <div className="inline-flex items-center gap-4 bg-[#2d2a26] p-4 rounded border border-[#555]">
              ...
              <div className="text-left text-sm opacity-80 leading-tight">
                [cite_start]Direct manipulation of
                <br />
                Process Memory & Entities [cite: 137]
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-4 border-b border-[#b8b8b8]">
          ...
          <div className="p-8 bg-[#39352f] text-white flex items-center justify-center">
            <a
              href="https://github.com/YOUR_USERNAME/REPO"
              target="_blank"
              className="group flex flex-col items-center gap-2 hover:text-[#d67d7d] transition-colors cursor-pointer"
            >
              ...
              <span className="font-bold text-sm tracking-widest border-b border-transparent group-hover:border-[#d67d7d]">
                VIEW GITHUB
              </span>
            </a>
          </div>
          ...
          <section className="md:w-2/3 p-10 md:p-16 space-y-12">
            ...
            <div>
              ...
              <p className="leading-relaxed">
                Inspired by the speedrunning community (@MCarma), I joined a
                competition to engineer a solution. [cite_start]My specific role
                was to <b>reverse engineer the game components</b> directly from
                the process memory. [cite: 134, 137]
              </p>
            </div>
              ...
              <div className="bg-white p-6 rounded shadow-sm border-l-4 border-[#39352f]">
                ...
                <ol className="list-decimal list-inside space-y-3 font-medium">
                  ...
                  <li>
                    ...
                    abstract memory access, making future updates easier. [cite:
                    142, 144]
                  </li>
                </ol>
              </div>
            ...
            <div>
              ...
              <p className="leading-relaxed mb-4">
                ...
                modern OOP practices, abstracting the memory access layer.
                [cite_start]This reduced overhead and improved stability. [cite:
                144]
              </p>
              <p className="leading-relaxed text-sm opacity-80 italic border-l-2 border-[#d67d7d] pl-4">
                [cite_start]Future Roadmap: Implementing security signatures and
                encryption to prevent malicious client data from corrupting the
                game state. [cite: 148]
              </p>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm font-mono">
                <li className="flex items-center gap-2">
                  ...
                  PvP & PvE Combat [cite: 123]
                </li>
                <li className="flex items-center gap-2">
                  [cite_start]
                  <span className="w-2 h-2 bg-green-500 rounded-full"></span>{" "}
                  Hide & Seek Mode [cite: 123]
                </li>
                <li className="flex items-center gap-2">
                  [cite_start]
                  <span className="w-2 h-2 bg-green-500 rounded-full"></span>{" "}
                  Quest Synchronization [cite: 131]
                </li>
              </ul>
            </div>
